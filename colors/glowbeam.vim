...
--[[ Highlite, a Neovim colorscheme template.
	...
	* Repository: https://github.com/nvim-glowbeam
...
--[[ Step 1: Renaming
	...
	* `lua/glowbeam.lua`
	...
	Where 'glowbeam' is the name of your colorscheme.
...
local highlight_groups = {
	...
	Character = {fg=gray_darker},
	Number    = {fg=yellow},
	Boolean   = {fg=pink, style='italic'},
	Float     = 'Number',
	...
	PmenuSel   = {fg=gray_dark, bg=tan},
	PmenuThumb = {bg=white},
	WildMenu   = {},

	--[[ 4.2.5. Folds]]
	FoldColumn = {bg=BG, fg=yellow, style='bold'},
	Folded     = {bg=BG,  fg=yellow, style='italic'},
	...
	Search     = {fg=yellow, style={'underline', color=white}},
	MatchParen = {fg=green},
	...
	ModeMsg    = {fg=yellow},
	WarningMsg = {fg=orange_light, style='italic'},
	...
	CocHintHighlight    = {style={'underline', color='magenta'}},
	CocInfoHighlight    = {style={'underline', color='pink_light'}},
...
--[[ Step 5: Sourcing
	...
	I source glowbeam by using `colorscheme glowbeam`.
	...
	* When used against a light background, strong colors work glowbeam than muted
...
-- Change 'glowbeam' to the name of your colorscheme as defined in step 1.
require('glowbeam')(
